...
class CoverageReporterTest {
  ...
  fun testGenerateMarkDownReport_withOverriddenHighCoverage_generatesFailStatusMarkdownTable() {
    ...
    val highCoverageRequiredCoverageReport =
      CoverageReport
        .newBuilder()
        .setDetails(
          CoverageDetails
  ...
  fun testGenerateMarkDownReport_withOverriddenLowCoverage_generatesPassStatusMarkdownTable() {
    ...
    val lowCoverageRequiredCoverageReport =
      CoverageReport
        .newBuilder()
        .setDetails(
          CoverageDetails
  ...
  private fun loadCoverageReportProto(coverageReportProtoPath: String): CoverageReport =
    File("$coverageReportProtoPath").inputStream().use { stream ->
      CoverageReport
        .newBuilder()
        .also { builder ->
