...
@Singleton
class QuestionTrainingController
  @Inject
  constructor(
      ...
      try {
        ...
        val beginSessionDataProvider =
          questionAssessmentProgressController.beginQuestionTrainingSession(
            questionsListDataProvider = retrieveQuestionsDataProvider,
            profileId,
          )
     ...
     * started.
     */
    fun stopQuestionTrainingSession(): DataProvider<Any?> = questionAssessmentProgressController.finishQuestionTrainingSession()
  }
