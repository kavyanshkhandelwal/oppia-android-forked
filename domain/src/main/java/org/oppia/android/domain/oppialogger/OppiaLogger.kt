...
class OppiaLogger
  ...
  constructor(
    ...
    fun createOpenPracticeTabContext(topicId: String): EventLog.Context =
      EventLog.Context
        .newBuilder()
        .setOpenPracticeTab(
    ...
    fun createOpenInfoTabContext(topicId: String): EventLog.Context =
      EventLog.Context
        .newBuilder()
        .setOpenInfoTab(
          EventLog.TopicContext
    ...
    fun createOpenLessonsTabContext(topicId: String): EventLog.Context =
      EventLog.Context
        .newBuilder()
        .setOpenLessonsTab(
          EventLog.TopicContext
    ...
    fun createOpenRevisionTabContext(topicId: String): EventLog.Context =
      EventLog.Context
        .newBuilder()
        .setOpenRevisionTab(
          EventLog.TopicContext
    ...
    fun createOpenConceptCardContext(skillId: String): EventLog.Context =
      EventLog.Context
        .newBuilder()
        .setOpenConceptCard(
          EventLog.ConceptCardContext
            .newBuilder()
            .setSkillId(skillId)
            .build(),
        ).build()
    ...
    fun createCloseRevisionCardContext(
      topicId: String,
      subtopicIndex: Int,
    ): EventLog.Context =
      EventLog.Context
    ...
    fun createAppOnBoardingContext(): EventLog.Context =
      EventLog.Context
        .newBuilder()
        .setCompleteAppOnboarding(
          EventLog.CompleteAppOnboardingContext
            .newBuilder()
    ...
    fun createProfileOnboardingStartedContext(profileId: ProfileId): EventLog.Context =
      EventLog.Context
        .newBuilder()
        .setStartProfileOnboardingEvent(
          EventLog.ProfileOnboardingContext
            .newBuilder()
    ...
    fun createRetrofitCallContext(
      ...
      EventLog.Context
        .newBuilder()
        .setRetrofitCallContext(
          EventLog.RetrofitCallContext
            .newBuilder()
            .setRequestUrl(url)
            .setHeaders(headers)
            .setBody(body)
    ...
    fun createRetrofitCallFailedContext(
      ...
      EventLog.Context
        .newBuilder()
        .setRetrofitCallFailedContext(
          EventLog.RetrofitCallFailedContext
            .newBuilder()
            .setRequestUrl(url)
            .setHeaders(headers)
            .setBody(body)
    ...
    fun createAppInForegroundTimeContext(
      ...
      EventLog.Context
        .newBuilder()
        .setAppInForegroundTime(
          EventLog.AppInForegroundTimeContext
            .newBuilder()
