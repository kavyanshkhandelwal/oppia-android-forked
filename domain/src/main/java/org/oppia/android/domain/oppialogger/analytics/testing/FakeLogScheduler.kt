...
@Singleton
class FakeLogScheduler
  @Inject
  constructor() : MetricLogScheduler {
     ...
     */
    fun getMostRecentStorageUsageMetricLoggingRequestId() = schedulingStorageUsageMetricLoggingRequestIdList.last()

    /**
     * Returns the most recent work request id that's stored in the
     * [schedulingPeriodicUiMetricLoggingRequestIdList].
     */
    fun getMostRecentPeriodicUiMetricLoggingRequestId() = schedulingPeriodicUiMetricLoggingRequestIdList.last()

    /**
     * Returns the most recent work request id that's stored in the
     * [schedulingPeriodicBackgroundMetricsLoggingRequestIdList].
     */
    fun getMostRecentPeriodicBackgroundMetricLoggingRequestId() = schedulingPeriodicBackgroundMetricsLoggingRequestIdList.last()
  }
