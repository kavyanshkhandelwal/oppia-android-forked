...
class PerformanceMetricsLogger
  ...
  constructor(
     ...
     */
    private fun createApkSizeLoggableMetric(apkSize: Long): OppiaMetricLog.LoggableMetric =
     ...
     */
    private fun createStorageUsageLoggableMetric(storageUsage: Long): OppiaMetricLog.LoggableMetric =
      OppiaMetricLog.LoggableMetric
        .newBuilder()
     ...
     */
    private fun createStartupLatencyLoggableMetric(startupLatency: Long): OppiaMetricLog.LoggableMetric =
      OppiaMetricLog.LoggableMetric
        .newBuilder()
     ...
     */
    private fun createMemoryUsageLoggableMetric(totalPssBytes: Long): OppiaMetricLog.LoggableMetric =
      OppiaMetricLog.LoggableMetric
        .newBuilder()
     ...
     */
    private fun createCpuUsageLoggableMetric(cpuUsage: Double): OppiaMetricLog.LoggableMetric =
      OppiaMetricLog.LoggableMetric
        .newBuilder()
        .setCpuUsageMetric(
