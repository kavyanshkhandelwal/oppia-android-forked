  ...
  constructor(
    ...
    private fun createTopicList(contentLocale: OppiaLocale.ContentLocale): TopicList {
      return if (loadLessonProtosFromAssets) {
        ...
        loadTopicListFromJson(contentLocale)
      }
    }
      ...
      return EphemeralTopicSummary
        ...
        .apply {
          ...
          classroomWrittenTranslationContext =
            translationController.computeWrittenTranslationContext(
              classroomRecord.writtenTranslationsMap,
              contentLocale,
            )
    ...
    private fun createUpcomingTopicSummaryFromJson(
      ...
      val classroomTitle =
        classroomJsonObject.getJSONObject("classroom_title").let {
          SubtitledHtml
            .newBuilder()
            .apply {
    ...
    private fun PromotedStoryList.getTotalPromotedStoryCount(): Int =
      recentlyPlayedStoryList.size + olderPlayedStoryList.size + suggestedStoryList.size
    ...
    private fun computePlayedStories(
      ...
      val sortedTopicProgressList =
        topicProgressList.sortedByDescending { topicProgress ->
          ...
          val topicProgressChapters =
            topicProgressStories.flatMap { storyProgress ->
    ...
    private fun getStartedChapterProgressList(storyProgress: StoryProgress): List<ChapterProgress> {
      val startedNotCompletedChapterList =
        getSortedChapterProgressListByPlayState(
          storyProgress,
          playState = ChapterPlayState.STARTED_NOT_COMPLETED,
        )
      val inProgressSavedChapterList =
        getSortedChapterProgressListByPlayState(
          storyProgress,
          playState = ChapterPlayState.IN_PROGRESS_SAVED,
        )
      val inProgressNotSavedChapterList =
        getSortedChapterProgressListByPlayState(
          storyProgress,
          playState = ChapterPlayState.IN_PROGRESS_NOT_SAVED,
        )
      return (
    ...
    private fun ChapterProgress.getNumberOfDaysPassed(): Long =
      TimeUnit.MILLISECONDS.toDays(oppiaClock.getCurrentTimeMs() - this.lastPlayedTimestamp)
   ...
   */
    private fun computeSuggestedStories(
      ...
      return if (loadLessonProtosFromAssets) {
        ...
        computeSuggestedStoriesFromJson(topicProgressList, contentLocale)
      }
    }
    ...
    private fun computeSuggestedStoriesForTopicIds(
      ...
      val fullyCompletedTopicIds =
        topicProgressList
          .filter { topicProgress ->
      ...
      val impliedFinishedTopicIds =
        computeImpliedCompletedDependencies(
    ...
    private fun computeTransitiveDependencyClosure(
      ...
      val transitiveDependencies =
        directDependencies.flatMap { dependentId ->
    ...
    private fun loadRecommendedStory(
      ...
      return if (loadLessonProtosFromAssets) {
        ...
        return PromotedStory
          ...
          .apply {
            ...
            storyWrittenTranslationContext =
              translationController.computeWrittenTranslationContext(
                storyRecord.writtenTranslationsMap,
                contentLocale,
              )
            topicWrittenTranslationContext =
              translationController.computeWrittenTranslationContext(
                topicRecord.writtenTranslationsMap,
                contentLocale,
              )
            classroomWrittenTranslationContext =
              translationController.computeWrittenTranslationContext(
        ...
        loadRecommendedStoryFromJson(topicId)
      }
    }
    ...
    private fun loadRecommendedStoryFromJson(topicId: String): PromotedStory? {
      ...
      if (topicJson!!.optString("topic_name").isNullOrEmpty()) {
        ...
        val topicTitle =
          topicJson.optString("topic_name").takeIf { it.isNotEmpty() }?.let {
            SubtitledHtml
              .newBuilder()
              .apply {
                contentId = "title"
        ...
        val classroomTitle =
          classroomJson.getJSONObject("classroom_title").let {
            SubtitledHtml
              .newBuilder()
              .apply {
                contentId = it.getStringFromObject("content_id")
    ...
    private fun createPromotedStory(
      ...
      return PromotedStory
        ...
        .setStoryWrittenTranslationContext(
          ...
          translationController.computeWrittenTranslationContext(
            nextChapterSummary.writtenTranslationsMap,
            contentLocale,
          ),
        ).setClassroomWrittenTranslationContext(
          translationController.computeWrittenTranslationContext(
            classroom.writtenTranslationsMap,
            contentLocale,
          ),
        ).setStoryTitle(storySummary.storyTitle)
        .setLessonThumbnail(storySummary.storyThumbnail)
