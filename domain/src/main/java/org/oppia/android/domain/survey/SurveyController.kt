...
class SurveyController
  ...
  constructor(
    ...
    private fun createSurvey(
      ...
      val mandatoryQuestionsList =
        mandatoryQuestionNames.mapIndexed { index, questionName ->
    ...
    private fun createDefaultFeedbackQuestion(questionId: String): SurveyQuestion =
      SurveyQuestion
        .newBuilder()
        .setQuestionId(questionId)
     ...
     * started.
     */
    fun stopSurveySession(surveyCompleted: Boolean): DataProvider<Any?> = surveyProgressController.endSurveySession(surveyCompleted)
  }
