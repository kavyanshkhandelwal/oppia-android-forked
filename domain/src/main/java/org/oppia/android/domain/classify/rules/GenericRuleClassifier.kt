...
class GenericRuleClassifier constructor(
  ...
  private val orderedExpectedParameterTypes: LinkedHashMap<
    String,
    InteractionObject.ObjectTypeCase,
  >,
  ...
  private fun retrieveInputObject(
    ...
    val input =
      checkNotNull(inputs[parameterName]) {
    ...
    class MultiTypeSingleInputMatcherDelegate<AT : Any, IT : Any>(
      ...
      override fun matches(
        ...
        return matcher.matches(
          ...
          extractInputObject(inputs.first()),
          classificationContext,
        )
      }
    }
  ...
  class Factory
    ...
    constructor(
      ...
      inline fun <reified T : Any> createSingleInputClassifier(
        ...
        return GenericRuleClassifier(
          expectedObjectType,
          linkedMapOf(inputParameterName to expectedObjectType),
      ...
      inline fun <reified AT : Any, reified IT : Any> createMultiTypeSingleInputClassifier(
        ...
        return GenericRuleClassifier(
          ...
          linkedMapOf(inputParameterName to expectedInputObjectType),
      ...
      inline fun <reified AT : Any, reified ITF : Any, reified ITS : Any> createDoubleInputClassifier(
        ...
        val parameters: LinkedHashMap<String, InteractionObject.ObjectTypeCase> =
          linkedMapOf(
        ...
        return GenericRuleClassifier(
          ...
          MatcherDelegate.MultiTypeDoubleInputMatcherDelegate(
            matcher,
            answerObjectExtractor,
            objectExtractorFirst,
            objectExtractorSecond,
          ),
        )
      }
