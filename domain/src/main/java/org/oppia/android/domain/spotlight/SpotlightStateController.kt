...
@Singleton
class SpotlightStateController
  @Inject
  constructor(
    ...
    class SpotlightFeatureNotFoundException(
      message: String,
    ...
    private fun recordSpotlightStateAsync(
      ...
      retrieveCacheStore(profileId).storeDataAsync(
    ...
    private fun retrieveCacheStore(profileId: ProfileId): PersistentCacheStore<SpotlightStateDatabase> {
      val cacheStore =
