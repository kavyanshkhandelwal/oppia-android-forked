...
class FakeExpirationMetaDataRetriever
  @Inject
  constructor() : ExpirationMetaDataRetriever {
    private val metaData = Bundle()

    override fun getMetaData(): Bundle? = metaData

    /** Convenience method for setting a string in the expiration meta data. */
    fun putMetaDataString(
      keyName: String,
      value: String,
    ) {
