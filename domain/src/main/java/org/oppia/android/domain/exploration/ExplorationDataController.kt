 ...
 */
class ExplorationDataController
  @Inject
  constructor(
     ...
     */
    fun deleteExplorationProgressById(
      profileId: ProfileId,
      explorationId: String,
    ) {
    ...
    private fun Exploration.toEphemeral(contentLocale: OppiaLocale.ContentLocale): EphemeralExploration =
        ...
        .apply {
          ...
          writtenTranslationContext =
            translationController.computeWrittenTranslationContext(
              exploration.writtenTranslationsMap,
              contentLocale,
            )
        }.build()
  }
