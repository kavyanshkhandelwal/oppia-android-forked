 ...
 */
fun HelpIndex.isHintRevealed(
  hintIndex: Int,
  hintList: List<Hint>,
): Boolean {
  val lastShownHintIndex =
    when (indexTypeCase) {
 ...
 */
fun HelpIndex.isSolutionAvailable(): Boolean = indexTypeCase == SHOW_SOLUTION || isSolutionRevealed()
