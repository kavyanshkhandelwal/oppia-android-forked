...
@Singleton
class PlatformParameterSingletonImpl
  @Inject
  constructor() : PlatformParameterSingleton {
    ...
    override fun getStringPlatformParameter(platformParameterName: String): PlatformParameterValue<String>? {
    ...
    override fun getIntegerPlatformParameter(platformParameterName: String): PlatformParameterValue<Int>? {
      if (platformParameterMap.isEmpty()) return null
      val parameter = platformParameterMap[platformParameterName] ?: return null
    ...
    override fun getBooleanPlatformParameter(platformParameterName: String): PlatformParameterValue<Boolean>? {
      if (platformParameterMap.isEmpty()) return null
      val parameter = platformParameterMap[platformParameterName] ?: return null
