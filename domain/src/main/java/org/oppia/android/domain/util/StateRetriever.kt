...
class StateRetriever
  ...
  constructor() {
    ...
    private fun createListOfHintsFromJson(hintsJson: JSONArray): List<Hint> {
      ...
      AnswerGroup
        ...
        .apply {
          ...
          val misconceptionJson =
            if (answerGroupJson.isNull("tagged_skill_misconception_id")) {
              null
            } else {
              answerGroupJson.getStringFromObject("tagged_skill_misconception_id")
            }
    ...
    private fun createVoiceoverMappingsFromJson(recordedVoiceovers: JSONObject): Map<String, VoiceoverMapping> {
      val voiceoverMappingJson = recordedVoiceovers.getJSONObject("voiceovers_mapping")
      return voiceoverMappingJson
        .keys()
        .asSequence()
        .filter { contentId ->
    ...
    private fun createWrittenTranslationMappingsFromJson(writtenTranslations: JSONObject): Map<String, TranslationMapping> {
      val translationsMappingJson = writtenTranslations.getJSONObject("translations_mapping")
      return translationsMappingJson
        .keys()
        .asSequence()
        .filter { contentId ->
    ...
    private fun parseTranslatableSetOfNormalizedString(translatableSetOfStringsJson: JSONObject): TranslatableSetOfNormalizedString =
      TranslatableSetOfNormalizedString
        .newBuilder()
        .apply {
    ...
    private fun parseListOfSetsOfTranslatableHtmlContentIds(listOfSetsOfContentIdsJson: JSONArray): ListOfSetsOfTranslatableHtmlContentIds {
    ...
    private fun parseSetOfTranslatableHtmlContentIds(setOfContentIdsJson: JSONArray): SetOfTranslatableHtmlContentIds {
    ...
    private fun createRatioExpressionInputCustomizationArgsMap(customizationArgsJson: JSONObject): Map<String, SchemaObject> {
    ...
    private fun createDragAndDropSortInputCustomizationArgsMap(customizationArgsJson: JSONObject): Map<String, SchemaObject> {
      val customizationArgsMap = mutableMapOf<String, SchemaObject>()
    ...
    private fun createFractionInputCustomizationArgsMap(customizationArgsJson: JSONObject): Map<String, SchemaObject> {
      val customizationArgsMap = mutableMapOf<String, SchemaObject>()
    ...
    private fun createImageClickInputCustomizationArgsMap(customizationArgsJson: JSONObject): Map<String, SchemaObject> {
      val customizationArgsMap = mutableMapOf<String, SchemaObject>()
    ...
    private fun createItemSelectionInputCustomizationArgsMap(customizationArgsJson: JSONObject): Map<String, SchemaObject> {
      val customizationArgsMap = mutableMapOf<String, SchemaObject>()
    ...
    private fun createMultipleChoiceInputCustomizationArgsMap(customizationArgsJson: JSONObject): Map<String, SchemaObject> {
      val customizationArgsMap = mutableMapOf<String, SchemaObject>()
      customizationArgsMap["choices"] =
        parseSubtitledHtmlListForCustomizationArgs(
          customizationArgsJson.getJSONObject("choices").getJSONArray("value"),
    ...
    private fun createTextInputCustomizationArgsMap(customizationArgsJson: JSONObject): Map<String, SchemaObject> {
      val customizationArgsMap = mutableMapOf<String, SchemaObject>()
    ...
    private fun createNumericExpressionInputCustomizationArgsMap(customizationArgsJson: JSONObject): Map<String, SchemaObject> {
      val customizationArgsMap = mutableMapOf<String, SchemaObject>()
    ...
    private fun parseIntegerSchemaObject(value: Int): SchemaObject = SchemaObject.newBuilder().setSignedInt(value).build()

    private fun parseBooleanSchemaObject(value: Boolean): SchemaObject = SchemaObject.newBuilder().setBoolValue(value).build()
