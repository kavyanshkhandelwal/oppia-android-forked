 ...
 */
class LogReportWorkManagerInitializer
  @Inject
  constructor(
    ...
    private val logReportWorkerConstraints =
      Constraints
        .Builder()
    ...
    private val workerCaseForUploadingEvents: Data =
      Data
        .Builder()
        .putString(
    ...
    private val workerCaseForUploadingExceptions: Data =
      Data
        .Builder()
        .putString(
          LogUploadWorker.WORKER_CASE_KEY,
    ...
    private val workerCaseForUploadingPerformanceMetrics: Data =
      Data
        .Builder()
        .putString(
          LogUploadWorker.WORKER_CASE_KEY,
    ...
    private val workerCaseForUploadingFirestoreData: Data =
      Data
        .Builder()
        .putString(
          LogUploadWorker.WORKER_CASE_KEY,
    ...
    private val workRequestForUploadingEvents: PeriodicWorkRequest =
      PeriodicWorkRequest
    ...
    private val workRequestForUploadingExceptions: PeriodicWorkRequest =
      PeriodicWorkRequest
        .Builder(LogUploadWorker::class.java, 6, TimeUnit.HOURS)
    ...
    private val workRequestForUploadingPerformanceMetrics: PeriodicWorkRequest =
      PeriodicWorkRequest
        .Builder(LogUploadWorker::class.java, 6, TimeUnit.HOURS)
     ...
     */
    fun getWorkRequestForSchedulingPeriodicUiMetricLogsId(): UUID = workRequestForSchedulingPeriodicUiMetricLogs.id

    /**
     * Returns the [UUID] of the work request that is enqueued for scheduling storage usage
     * performance metrics collection.
     */
    fun getWorkRequestForSchedulingStorageUsageMetricLogsId(): UUID = workRequestForSchedulingStorageUsageMetricLogs.id
     ...
     */
    fun getWorkRequestDataForSchedulingStorageUsageMetricLogs(): Data = workerCaseForSchedulingStorageUsageMetricLogs

    /**
     * Returns the [Data] that goes into the work request that is enqueued for scheduling memory
     * usage performance metrics collection.
     */
    fun getWorkRequestDataForSchedulingPeriodicUiMetricLogs(): Data = workerCaseForSchedulingPeriodicUiMetricLogs

    /**
     * Returns the [Data] that goes into the work request that is enqueued for scheduling periodic
     * performance metrics collection.
     */
    fun getWorkRequestDataForSchedulingPeriodicBackgroundPerformanceMetricLogs(): Data = workerCaseForSchedulingPeriodicBackgroundMetricLogs
