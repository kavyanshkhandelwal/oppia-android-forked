...
class AnswerClassificationControllerTest {
  companion object {
    ...
    private val TEST_STRING_INPUT_SET_2_WITH_CONTENT_ID =
      createTranslatableSetOfNormalizedString(
        TEST_STRING_3_ENGLISH,
        contentId = TEST_STRING_3_CONTENT_ID,
      )
  ...
  private fun setUpTestApplicationComponent() {
    DaggerAnswerClassificationControllerTest_TestApplicationComponent
      .builder()
