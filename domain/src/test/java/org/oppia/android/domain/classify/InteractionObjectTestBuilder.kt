...
object InteractionObjectTestBuilder {
  fun createNonNegativeInt(value: Int): InteractionObject = InteractionObject.newBuilder().setNonNegativeInt(value).build()

  fun createString(value: String): InteractionObject = InteractionObject.newBuilder().setNormalizedString(value).build()
  ...
  fun createTranslatableHtmlContentId(contentId: String): InteractionObject =
    InteractionObject
      .newBuilder()
      .apply {
  ...
  fun createSetOfTranslatableHtmlContentIds(vararg contentIds: String): InteractionObject =
    InteractionObject
      .newBuilder()
      .apply {
  ...
  fun createListOfSetsOfTranslatableHtmlContentIds(vararg contentIdsLists: List<String>): InteractionObject =
    InteractionObject
      .newBuilder()
      .apply {
  ...
  fun createNumberWithUnitsForFraction(
    number: Fraction,
    units: List<NumberUnit>,
  ): InteractionObject {
    val numberWithUnits =
      NumberWithUnits
        .newBuilder()
  ...
  fun createNumberWithUnitsForReal(
    number: Double,
    units: List<NumberUnit>,
  ): InteractionObject {
    val numberWithUnits =
  ...
  fun createSignedInt(value: Int): InteractionObject = InteractionObject.newBuilder().setSignedInt(value).build()

  fun createReal(value: Double): InteractionObject = InteractionObject.newBuilder().setReal(value).build()

  fun createInt(value: Int): InteractionObject = InteractionObject.newBuilder().setReal(value.toDouble()).build()
