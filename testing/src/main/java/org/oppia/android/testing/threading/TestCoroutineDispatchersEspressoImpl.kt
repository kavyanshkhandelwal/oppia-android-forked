 ...
 */
class TestCoroutineDispatchersEspressoImpl
  @Inject
  constructor(
    ...
    private val dispatcherIdlenessTracker =
      DispatcherIdlenessTracker(
    ...
    private inner class TestCoroutineDispatcherIdlingResource : IdlingResource {
      ...
      override fun getName(): String = "TestCoroutineDispatcherIdlingResource"

      override fun isIdleNow(): Boolean = !hasPendingCompletableTasks()
    ...
    private inner class DispatcherIdlenessTracker(
      ...
      fun initialize() {
        dispatchers.forEachIndexed { index, dispatcher ->
          dispatcher.setTaskIdleListener(
            object : TaskIdleListener {
