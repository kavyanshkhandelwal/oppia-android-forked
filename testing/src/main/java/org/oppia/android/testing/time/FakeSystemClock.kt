  ...
  constructor(
    ...
    private sealed class TimeCoordinator {
      ...
      private object RobolectricTimeCoordinator : TimeCoordinator() {
        ...
        override fun getCurrentTimeMillis(): Long = retrieveCurrentTimeMethod.invoke(foregroundScheduler) as Long
        ...
        private fun loadRobolectricClass(): Class<*>? = FakeSystemClock::class.java.classLoader?.loadClass("org.robolectric.Robolectric")
        ...
        private fun loadRetrieveCurrentTimeMethod(): Method? = foregroundScheduler.javaClass.getDeclaredMethod("getCurrentTime")

        private fun loadAdvanceToMethod(): Method? = foregroundScheduler.javaClass.getDeclaredMethod("advanceTo", Long::class.java)
      }
