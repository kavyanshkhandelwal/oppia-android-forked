  ...
  private class BooleanParameterValue private constructor(
    ...
    companion object {
      ...
      internal fun createParameter(
        key: String,
        rawValue: String,
      ): ParameterValue? = rawValue.toBooleanStrictOrNull()?.let { BooleanParameterValue(key, it) }
  ...
  private class IntParameterValue private constructor(
    ...
    companion object {
      ...
      internal fun createParameter(
        key: String,
        rawValue: String,
      ): ParameterValue? = rawValue.toIntOrNull()?.let { IntParameterValue(key, it) }
    }
  }
  ...
  private class LongParameterValue private constructor(
    ...
    companion object {
      ...
      internal fun createParameter(
        key: String,
        rawValue: String,
      ): ParameterValue? = rawValue.toLongOrNull()?.let { LongParameterValue(key, it) }
    }
  }
  ...
  private class FloatParameterValue private constructor(
    ...
    companion object {
      ...
      internal fun createParameter(
        key: String,
        rawValue: String,
      ): ParameterValue? = rawValue.toFloatOrNull()?.let { FloatParameterValue(key, it) }
    }
  }
  ...
  private class DoubleParameterValue private constructor(
    ...
    companion object {
      ...
      internal fun createParameter(
        key: String,
        rawValue: String,
      ): ParameterValue? = rawValue.toDoubleOrNull()?.let { DoubleParameterValue(key, it) }
    }
  }
  ...
  private class StringParameterValue private constructor(
    ...
    companion object {
      ...
      internal fun createParameter(
        key: String,
        rawValue: String,
      ): ParameterValue = StringParameterValue(key, rawValue)
    }
  }

  companion object {
    private val booleanValueParser =
      object : ParameterValueParser {
        override fun parseParameter(
          key: String,
          rawValue: String,
        ): ParameterValue? = BooleanParameterValue.createParameter(key, rawValue)
      }
    private val intValueParser =
      object : ParameterValueParser {
        override fun parseParameter(
          key: String,
          rawValue: String,
        ): ParameterValue? = IntParameterValue.createParameter(key, rawValue)
      }
    private val longValueParser =
      object : ParameterValueParser {
        override fun parseParameter(
          key: String,
          rawValue: String,
        ): ParameterValue? = LongParameterValue.createParameter(key, rawValue)
      }
    private val floatValueParser =
      object : ParameterValueParser {
        override fun parseParameter(
          key: String,
          rawValue: String,
        ): ParameterValue? = FloatParameterValue.createParameter(key, rawValue)
      }
    private val doubleValueParser =
      object : ParameterValueParser {
        override fun parseParameter(
          key: String,
          rawValue: String,
        ): ParameterValue? = DoubleParameterValue.createParameter(key, rawValue)
      }
    private val stringValueParser =
      object : ParameterValueParser {
        override fun parseParameter(
          key: String,
          rawValue: String,
        ): ParameterValue = StringParameterValue.createParameter(key, rawValue)
      }
