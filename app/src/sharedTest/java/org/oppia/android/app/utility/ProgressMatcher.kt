...
class ProgressMatcher private constructor(
  private val progress: Int,
) : BoundedMatcher<View?, ProgressBar>(
    ProgressBar::class.java,
  ) {
  override fun matchesSafely(progressBar: ProgressBar): Boolean = progressBar.progress == progress
  ...
  companion object {
     ...
     */
    @CheckResult
    fun withProgress(progress: Int): ProgressMatcher = ProgressMatcher(progress)
  }
}
