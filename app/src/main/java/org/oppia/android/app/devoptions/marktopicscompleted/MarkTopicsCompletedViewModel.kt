 ...
 */
@FragmentScope
class MarkTopicsCompletedViewModel
  @Inject
  constructor(
    ...
    private fun getAllTopics(): LiveData<List<EphemeralTopic>> = Transformations.map(allTopicsResultLiveData, ::processAllTopicsResult)

    private fun processAllTopicsResult(ephemeralResult: AsyncResult<List<EphemeralTopic>>): List<EphemeralTopic> =
