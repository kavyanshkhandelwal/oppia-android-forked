...
class ProfileProgressViewModel
  ...
  constructor(
    ...
    private val itemViewModelList: MutableList<ProfileProgressItemViewModel> =
      mutableListOf(
    ...
    private fun processPromotedActivityListResult(promotedActivityListResult: AsyncResult<PromotedActivityList>): PromotedActivityList =
      when (promotedActivityListResult) {
        is AsyncResult.Failure -> {
          oppiaLogger.e(
    ...
    private fun processPromotedActivityList(recommendedActivityList: PromotedActivityList): List<ProfileProgressItemViewModel> {
