...
class StateFragmentPresenter
  ...
  constructor(
    ...
    private fun createRecyclerViewAssembler(
      ...
      return builder
        ...
        .addAudioVoiceoverSupport(
          explorationId,
          stateViewModel.currentStateName,
          stateViewModel.isAudioBarVisible,
    ...
    private fun getAudioFragment(): Fragment? = fragment.childFragmentManager.findFragmentByTag(TAG_AUDIO_FRAGMENT)
    ...
    private fun showHintsAndSolutions(
      helpIndex: HelpIndex,
      isCurrentStatePendingState: Boolean,
    ) {
    ...
    private class BounceUpAndDownInterpolator : Interpolator {
      ...
      override fun getInterpolation(input: Float): Float {
        ...
        return if (input <= 0.5f) {
          ...
          bounceInterpolator.getInterpolation(input * 2f - 1f)
        }
      }
    }
