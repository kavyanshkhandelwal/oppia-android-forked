...
class ResumeLessonFragmentPresenter
  @Inject
  constructor(
    ...
    fun handleOnCreate(
      ...
      binding =
        ResumeLessonFragmentBinding.inflate(
          inflater,
          container,
          // attachToRoot=
          false,
    ...
    private fun getChapterSummary(): LiveData<EphemeralChapterSummary> =
      Transformations.map(chapterSummaryResultLiveData, ::processChapterSummaryResult)

    private fun processChapterSummaryResult(ephemeralResult: AsyncResult<EphemeralChapterSummary>): EphemeralChapterSummary =
    ...
    private fun playExploration(
      ...
      val startPlayingProvider =
        if (checkpoint == ExplorationCheckpoint.getDefaultInstance()) {
