...
class AudioLanguageFragmentPresenterV1
  @Inject
  constructor(
    ...
    fun getLanguageSelected(): AudioLanguage =
      audioLanguageSelectionViewModel.selectedLanguage.value
    ...
    private fun createRecyclerViewAdapter(): BindableAdapter<AudioLanguageItemViewModel> =
      singleTypeBuilderFactory
        .create<AudioLanguageItemViewModel>()
