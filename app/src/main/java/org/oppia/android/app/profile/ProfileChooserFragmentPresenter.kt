...
@FragmentScope
class ProfileChooserFragmentPresenter
  @Inject
  constructor(
    ...
    fun handleCreateView(
      ...
      binding =
        ProfileChooserFragmentBinding.inflate(
          inflater,
          container,
          // attachToRoot=
          false,
    ...
    private fun processWasProfileEverBeenAddedResult(wasProfileEverBeenAddedResult: AsyncResult<Boolean>): Boolean =
      when (wasProfileEverBeenAddedResult) {
