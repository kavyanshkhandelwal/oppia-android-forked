...
@FragmentScope
class OnboardingFragmentPresenterV1
  @Inject
  constructor(
      ...
      onboardingViewPagerBindableAdapter.setData(
        listOf(
          OnboardingSlideViewModel(
            context = activity,
            viewPagerSlide = ViewPagerSlide.SLIDE_0,
            resourceHandler,
          ),
          OnboardingSlideViewModel(
            context = activity,
            viewPagerSlide = ViewPagerSlide.SLIDE_1,
            resourceHandler,
          ),
          OnboardingSlideViewModel(
            context = activity,
            viewPagerSlide = ViewPagerSlide.SLIDE_2,
            resourceHandler,
          ),
    ...
    private fun bindOnboardingSlideFinal(
      ...
      binding.slideTermsOfServiceAndPrivacyPolicyLinksTextView.text =
        htmlParserFactory
          .create(
