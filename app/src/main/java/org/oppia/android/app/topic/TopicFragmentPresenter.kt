...
class TopicFragmentPresenter
  ...
  constructor(
        ...
        if (numberOfChaptersCompleted != null) {
          ...
          lessonsTabView?.let {
            ...
            if (numberOfChaptersCompleted > 2) {
              ...
              val revisionTabSpotlightTarget =
                SpotlightTarget(
                  revisionTabView!!,
    ...
    private fun computeTabPosition(tab: TopicTab): Int =
      if (enableExtraTopicTabsUi.value) tab.positionWithFourTabs else tab.positionWithTwoTabs
