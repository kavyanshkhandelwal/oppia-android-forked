...
class ImageRegionSelectionTestFragmentPresenter
  @Inject
  constructor(
    ...
    fun handleCreateView(
      ...
      with(view) {
        ...
        view
          .findViewById<ImageRegionSelectionInteractionView>(R.id.clickable_image_view)
          .apply {
      ...
      LabeledRegion
        ...
        .setRegion(
          LabeledRegion.Region
            ...
            .setArea(
              LabeledRegion.Region.NormalizedRectangle2d
                .newBuilder()
