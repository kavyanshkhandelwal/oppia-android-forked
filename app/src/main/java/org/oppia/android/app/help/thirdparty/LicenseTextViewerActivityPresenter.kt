...
@ActivityScope
class LicenseTextViewerActivityPresenter
  @Inject
  constructor(
    ...
    fun handleOnCreate(
      ...
      val licenseNamesArrayResId =
        dependenciesWithLicenseNames.getResourceId(
          dependencyIndex,
          0,
        )
      ...
      if (getLicenseTextViewerFragment() == null) {
        ...
        activity.supportFragmentManager
          .beginTransaction()
          .add(R.id.license_text_viewer_fragment_placeholder, licenseTextViewerFragment)
          .commitNow()
      }
    }
