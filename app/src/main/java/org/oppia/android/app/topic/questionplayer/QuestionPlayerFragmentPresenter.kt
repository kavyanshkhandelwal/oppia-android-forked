...
@FragmentScope
class QuestionPlayerFragmentPresenter
  @Inject
  constructor(
    ...
    private fun retrieveArguments(): QuestionPlayerFragmentArguments =
      fragment.requireArguments().getProto(
        QuestionPlayerFragment.ARGUMENTS_KEY,
    ...
    fun getUserAnswerState(): UserAnswerState = questionViewModel.getUserAnswerState(recyclerViewAssembler::getPendingAnswerHandler)
    ...
    private fun processAnsweredQuestionOutcome(
      ...
      when (answeredQuestionOutcomeResult) {
        is AsyncResult.Failure -> {
          oppiaLogger.e(
            "QuestionPlayerFragment",
    ...
    private fun logQuestionPlayerEvent(
      questionId: String,
