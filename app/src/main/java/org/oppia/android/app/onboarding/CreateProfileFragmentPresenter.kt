...
@FragmentScope
class CreateProfileFragmentPresenter
  @Inject
  constructor(
    ...
    fun handleCreateView(
      ...
      binding =
        CreateProfileFragmentBinding.inflate(
          inflater,
          container,
          // attachToRoot=
          false,
      ...
      binding.onboardingNavigationContinue.setOnClickListener {
        val nickname =
          binding.createProfileNicknameEdittext.text
            .toString()
            .trim()
      ...
      binding.createProfileNicknameEdittext.addTextChangedListener(
        object : TextWatcher {
    ...
    private fun selectUniqueRandomColor(): Int = ContextCompat.getColor(fragment.requireContext(), COLORS_LIST.random())

    private companion object {
      private val COLORS_LIST =
        listOf(
