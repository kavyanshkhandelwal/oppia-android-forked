...
class MarketFitItemsViewModel
  ...
  constructor(
    ...
    override fun getPreviousAnswer(): SurveySelectedAnswer = SurveySelectedAnswer.getDefaultInstance()
    ...
    override fun restorePreviousAnswer(previousAnswer: SurveySelectedAnswer) {
      ...
      val previousSelection =
        previousAnswer.marketFit.number
          .takeIf { it != 0 }
          ?.minus(1)
    ...
    private fun getMarketFitOptions(): ObservableList<MultipleChoiceOptionContentViewModel> {
      ...
      observableList +=
        filteredmarketFitAnswer
          .mapIndexed { index, marketFitAnswer ->
            when (marketFitAnswer) {
              MarketFitAnswer.VERY_DISAPPOINTED ->
              ...
              MarketFitAnswer.NOT_DISAPPOINTED ->
                MultipleChoiceOptionContentViewModel(
                  resourceHandler.getStringInLocale(
