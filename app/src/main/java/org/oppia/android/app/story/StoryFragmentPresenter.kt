...
class StoryFragmentPresenter
  ...
  constructor(
        ...
        .create<StoryItemViewModel, ViewType> { viewModel ->
          ...
          bindView = { view, viewModel ->
            ...
            if (storyItemViewModel.chapterSummary.chapterPlayState
              ...
              val missingPrerequisiteSummary =
              ...
              if (!accessibilityService.isScreenReaderEnabled()) {
                ...
                chapterLockedSpannable.setSpan(
                  clickableSpan,
                  // start=
                  LOCKED_CARD_PREFIX_LENGTH,
                  // end=
                  chapterLockedSpannable.length - LOCKED_CARD_SUFFIX_LENGTH,
    ...
    private fun createSmoothScroller(): RecyclerView.SmoothScroller {
      ...
      return object : LinearSmoothScroller(activity) {
        ...
        override fun calculateDyToMakeVisible(
          view: View,
          snapPreference: Int,
        ): Int = super.calculateDyToMakeVisible(view, snapPreference) + dipToPixels(48)
      }
    }
    ...
    private fun logStoryActivityEvent(
      topicId: String,
      storyId: String,
    ) {
