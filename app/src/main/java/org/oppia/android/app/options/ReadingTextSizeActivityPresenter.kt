...
@ActivityScope
class ReadingTextSizeActivityPresenter
  @Inject
  constructor(
    ...
    fun handleOnCreate(preferredTextSize: ReadingTextSize) {
      ...
      if (getReadingTextSizeFragment() == null) {
        ...
        activity.supportFragmentManager
          .beginTransaction()
          .add(R.id.reading_text_size_container, readingTextSizeFragment)
          .commitNow()
      }
    }
    ...
    fun getSelectedReadingTextSize(): ReadingTextSize = fontSize
