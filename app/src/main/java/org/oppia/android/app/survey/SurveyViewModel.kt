...
class SurveyViewModel
  ...
  constructor(
    ...
    fun updateQuestionProgress(progressPercentage: Int) {
    ...
    fun setCanMoveToNextQuestion(canMoveToNext: Boolean) = this.canMoveToNextQuestion.set(canMoveToNext)
    ...
    private fun getQuestionText(questionName: SurveyQuestionName): String {
