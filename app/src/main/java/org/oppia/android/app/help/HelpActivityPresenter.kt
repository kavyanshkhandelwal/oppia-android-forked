...
class HelpActivityPresenter
  ...
  constructor(
    ...
    fun handleLoadLicenseTextViewerFragment(
      dependencyIndex: Int,
      licenseIndex: Int,
    ) {
      ...
      val licenseTextViewerFragment =
        LicenseTextViewerFragment.newInstance(
          dependencyIndex,
          licenseIndex,
        )
      activity.supportFragmentManager
    ...
    private fun loadMultipaneFragment(
      ...
      when (selectedFragment) {
        ...
        LICENSE_TEXT_FRAGMENT_TAG ->
          handleLoadLicenseTextViewerFragment(
            dependencyIndex,
            licenseIndex,
          )
      }
    ...
    private fun selectLicenseTextViewerFragment(
      dependencyIndex: Int,
      licenseIndex: Int,
    ) {
    ...
    private fun retrieveLicenseName(
      dependencyIndex: Int,
      licenseIndex: Int,
    ): String {
    ...
    private fun setHelpBackButtonContentDescription(fragmentTag: String) {
      when (fragmentTag) {
        LICENSE_LIST_FRAGMENT_TAG -> {
          ...
          activity
            .findViewById<ImageButton>(R.id.help_multipane_options_back_button)
            .contentDescription =
