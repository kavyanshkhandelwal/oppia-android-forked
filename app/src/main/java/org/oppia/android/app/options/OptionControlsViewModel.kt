...
class OptionControlsViewModel
  ...
  constructor(
    ...
    private fun processViewModelListsResult(asyncOptionsResult: AsyncResult<List<OptionsItemViewModel>>): List<OptionsItemViewModel> =
      when (asyncOptionsResult) {
    ...
    private fun createAudioLanguageViewModel(audioLanguage: AudioLanguage): OptionsAudioLanguageViewModel =
