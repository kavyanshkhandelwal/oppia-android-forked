...
class AppLanguageFragmentPresenter
  ...
  constructor(
    ...
    fun handleOnCreateView(
      ...
      val binding =
        AppLanguageFragmentBinding.inflate(
          inflater,
          container,
          // attachToRoot=
          false,
    ...
    fun getLanguageSelected(): OppiaLanguage =
      appLanguageSelectionViewModel.selectedLanguage.value
    ...
    private fun createRecyclerViewAdapter(): BindableAdapter<AppLanguageItemViewModel> =
      singleTypeBuilderFactory
        .create<AppLanguageItemViewModel>()
    ...
    private fun updateAppLanguage(appLanguage: OppiaLanguage) {
      ...
      when (val parentActivity = fragment.activity) {
        ...
        is AppLanguageActivity ->
          parentActivity.appLanguageActivityPresenter.setLanguageSelected(
            appLanguage,
          )
      }
    }
