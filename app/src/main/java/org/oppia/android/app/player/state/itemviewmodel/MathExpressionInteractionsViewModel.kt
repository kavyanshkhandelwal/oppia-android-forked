...
class MathExpressionInteractionsViewModel private constructor(
...
) : StateItemViewModel(interactionType.viewType),
  ...
  private fun deriveHintText(interaction: Interaction): CharSequence {
    ...
    if (interactionType.hasPlaceholder) {
      ...
      return resourceHandler.getStringInLocale(interactionType.defaultHintTextStringId)
    }
  }

  private fun retrieveAllowedVariables(interaction: Interaction): List<String> =
    if (interactionType.hasCustomVariables) {
  ...
  class FactoryImpl private constructor(
    ...
    override fun create(
      ...
      MathExpressionInteractionsViewModel(
        interaction,
        hasConversationView,
        answerErrorReceiver,
    ...
    enum class InteractionType(
      ...
      NUMERIC_EXPRESSION(
        ...
        override fun computeLatex(
          ...
          parseAnswer(answerText, allowedVariables)
            .getResult()
        ...
        override fun computeHumanReadableString(
          ...
          parseAnswer(answerText, allowedVariables).getResult()?.let { exp ->
        ...
        override fun parseAnswer(
          answerText: String,
          allowedVariables: List<String>,
        ): MathParsingResult<MathExpression> = MathExpressionParser.parseNumericExpression(answerText)
      },
      ...
      ALGEBRAIC_EXPRESSION(
        ...
        override fun parseAnswer(
          answerText: String,
          allowedVariables: List<String>,
        ): MathParsingResult<MathExpression> = MathExpressionParser.parseAlgebraicExpression(answerText, allowedVariables)
      },
      ...
      MATH_EQUATION(
        ...
        override fun parseAnswer(
          answerText: String,
          allowedVariables: List<String>,
        ): MathParsingResult<MathEquation> = MathExpressionParser.parseAlgebraicEquation(answerText, allowedVariables)
      }, ;
      ...
      fun computeSubmitTimeError(
        ...
        return when (val parseResult = parseAnswer(answerText, allowedVariables)) {
          is MathParsingResult.Failure ->
            when (val error = parseResult.error) {
              ...
              is InvalidFunctionInUseError -> {
                appLanguageResourceHandler.getStringInLocaleWithWrapping(
                  R.string.math_expression_error_unsupported_function,
                  error.functionName,
                )
              }
              is MultipleRedundantParenthesesError -> {
                appLanguageResourceHandler.getStringInLocaleWithWrapping(
                  R.string.math_expression_error_multiple_redundant_parentheses,
                  error.rawExpression,
                )
              }
              ...
              is NoVariableOrNumberAfterBinaryOperatorError ->
                when (error.operator) {
                  UnaryOperator.ADD -> {
                    appLanguageResourceHandler.getStringInLocaleWithWrapping(
              ...
              is NoVariableOrNumberBeforeBinaryOperatorError ->
                when (error.operator) {
                  UnaryOperator.ADD -> {
                    appLanguageResourceHandler.getStringInLocaleWithWrapping(
              ...
              is SingleRedundantParenthesesError -> {
                appLanguageResourceHandler.getStringInLocaleWithWrapping(
                  R.string.math_expression_error_single_redundant_parentheses,
                  error.rawExpression,
                )
              }
              ...
              is UnnecessarySymbolsError -> {
                appLanguageResourceHandler.getStringInLocaleWithWrapping(
                  R.string.math_expression_error_unnecessary_symbols,
                  error.invalidSymbol,
                )
              }
      ...
      protected companion object {
         ...
         */
        fun <T> MathParsingResult<T>.getResult(): T? =
          when (this) {
