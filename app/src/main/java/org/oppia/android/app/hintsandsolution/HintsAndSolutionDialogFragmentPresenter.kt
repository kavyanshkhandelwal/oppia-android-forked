  ...
  constructor(
    ...
    private fun createRecyclerViewAdapter(): BindableAdapter<HintsAndSolutionItemViewModel> =
      multiTypeBuilderFactory
        .create<HintsAndSolutionItemViewModel, ViewType> { viewModel ->
          when (viewModel) {
    ...
    private fun bindHintViewModel(
      binding: HintSummaryBinding,
