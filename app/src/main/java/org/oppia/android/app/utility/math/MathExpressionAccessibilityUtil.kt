 ...
 */
class MathExpressionAccessibilityUtil
  @Inject
  constructor(
    ...
    fun convertToHumanReadableString(
      ...
      when (language) {
        ...
        LANGUAGE_UNSPECIFIED, UNRECOGNIZED,
        -> null
      }
    ...
    private fun MathEquation.toHumanReadableEnglishString(divAsFraction: Boolean): String? {
      ...
      return if (lhsStr != null && rhsStr != null) {
        resourceHandler.getStringInLocaleWithWrapping(
          R.string.math_accessibility_a_equals_b,
          lhsStr,
          rhsStr,
        )
      } else {
      ...
      return when (expressionTypeCase) {
        ...
        BINARY_OPERATION -> {
          ...
          when (binaryOperation.operator) {
            ADD -> {
              resourceHandler.getStringInLocaleWithWrapping(
                R.string.math_accessibility_a_plus_b,
                lhsStr,
                rhsStr,
              )
            }
            SUBTRACT -> {
              resourceHandler.getStringInLocaleWithWrapping(
                R.string.math_accessibility_a_minus_b,
                lhsStr,
                rhsStr,
              )
            }
            MULTIPLY -> {
              val strResId =
                if (binaryOperation.canBeReadAsImplicitMultiplication()) {
                  ...
                  R.string.math_accessibility_a_times_b
                }
                ...
                divAsFraction ->
                  when {
                    ...
                    binaryOperation.isSimpleFraction() -> {
                      resourceHandler.getStringInLocaleWithWrapping(
                        R.string.math_accessibility_simple_fraction,
                        lhsStr,
                        rhsStr,
                      )
                    }
                      ...
                      resourceHandler.getStringInLocaleWithWrapping(
                        R.string.math_accessibility_complex_fraction,
                        lhsStr,
                        rhsStr,
                      )
                    }
                  ...
                  resourceHandler.getStringInLocaleWithWrapping(
                    R.string.math_accessibility_a_divides_b,
                    lhsStr,
                    rhsStr,
                  )
                }
            ...
            EXPONENTIATE -> {
              resourceHandler.getStringInLocaleWithWrapping(
                R.string.math_accessibility_a_exp_b,
                lhsStr,
                rhsStr,
              )
            }
        ...
        UNARY_OPERATION -> {
          ...
          when (unaryOperation.operator) {
            NEGATE ->
              operandStr?.let {
                resourceHandler.getStringInLocaleWithWrapping(
                  R.string.math_accessibility_negative_a,
                  it,
                )
              }
            POSITIVE ->
              operandStr?.let {
                resourceHandler.getStringInLocaleWithWrapping(
                  R.string.math_accessibility_positive_a,
                  it,
                )
              }
            ...
            SQUARE_ROOT ->
              argStr?.let {
                if (functionCall.argument.isSingleTerm()) {
                  resourceHandler.getStringInLocaleWithWrapping(
                    R.string.math_accessibility_simple_square_root,
                    it,
                  )
                } else {
                  resourceHandler.getStringInLocaleWithWrapping(
                    R.string.math_accessibility_complex_square_root,
                    it,
                  )
                }
              }
        ...
        GROUP ->
          group.toHumanReadableEnglishString(divAsFraction)?.let {
            if (!isSingleTerm()) {
    ...
    private companion object {
      ...
      private fun MathExpression.isSimpleFractionTerm(): Boolean =
        when (expressionTypeCase) {
