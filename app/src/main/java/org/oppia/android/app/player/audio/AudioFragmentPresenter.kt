...
class AudioFragmentPresenter
  ...
  constructor(
    ...
    fun handleCreateView(
      ...
      cellularAudioDialogController
        .getCellularDataPreference()
        .toLiveData()
        .observe(
          fragment,
          {
    ...
    private fun startSpotlights() {
      val audioLanguageIconSpotlightTarget =
        SpotlightTarget(
    ...
    fun handleAudioClick(
      shouldEnableAudioPlayback: Boolean,
      feedbackId: String?,
    ) {
