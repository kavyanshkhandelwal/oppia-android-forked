 ...
 */
@Singleton
class AsyncDataSubscriptionManager
  @Inject
  constructor(
    ...
    fun subscribe(
      id: Any,
      observeChange: ObserveAsyncChange,
    ) {
    ...
    fun unsubscribe(
      id: Any,
      observeChange: ObserveAsyncChange,
    ): Boolean = subscriptionLock.withLock { subscriptionMap[id]?.remove(observeChange) } ?: false
     ...
     */
    private fun verifyNoCyclesInClosure(
      parentId: Any,
      newChildId: Any,
    ): Any? {
