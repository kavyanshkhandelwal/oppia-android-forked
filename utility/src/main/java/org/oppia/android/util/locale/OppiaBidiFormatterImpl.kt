...
class OppiaBidiFormatterImpl private constructor(
  locale: Locale,
) : OppiaBidiFormatter {
  ...
  class FactoryImpl
    @Inject
    constructor() : OppiaBidiFormatter.Factory {
      override fun createFormatter(locale: Locale): OppiaBidiFormatter = OppiaBidiFormatterImpl(locale)
    }
}
