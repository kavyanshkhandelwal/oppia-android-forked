...
class ProfileNameValidator
  ...
  constructor() {
     ...
     */
    fun isNameValid(name: String): Boolean = containsOnlyLettersAndAllowedSymbols(name) && containsNoRepeatedUseOfAllowedSymbols(name)
    ...
    private fun containsNoRepeatedUseOfAllowedSymbols(name: String): Boolean = !name.contains(noRepeatedAllowedSymbolsRegex)
