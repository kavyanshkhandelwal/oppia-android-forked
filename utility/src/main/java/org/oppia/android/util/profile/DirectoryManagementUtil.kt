...
class DirectoryManagementUtil
  ...
  constructor(
     ...
     */
    fun getOrCreateDir(profileId: String): File = context.getDir(profileId, Context.MODE_PRIVATE)
     ...
     */
    fun deleteDir(profileId: String): Boolean = getOrCreateDir(profileId).deleteRecursively()
  }
